...
DATABASES = {
	"default": dj_database_url.parse('postgres://bloomroom_user:mt01KM3jMPGlfLEEnhVFKwCbdmjdFp6l@dpg-cjmu7bsdfrcc73cbnf70-a.oregon-postgres.render.com/bloomroom')
}
